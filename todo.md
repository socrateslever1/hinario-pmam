...
## Cache de Vídeos YouTube

- [ ] Criar hook useYouTubeCache para rastrear vídeos assistidos
- [ ] Implementar cache de thumbnails de vídeos YouTube
- [ ] Armazenar metadados de vídeos (título, duração, ID)
- [ ] Indicador de disponibilidade offline para vídeos
- [ ] UI para gerenciar downloads de vídeos
- [ ] Sincronizar histórico de vídeos assistidos
- [ ] Testes de cache de vídeos
