...
## Melhorias no Painel de Posts (Jornalístico)

- [x] Instalar TipTap para editor de texto rico
- [x] Implementar editor com formatação (negrito, itálico, listas, links, títulos, blockquotes)
- [x] Adicionar suporte a upload de vídeos (YouTube, arquivo local)
- [ ] Adicionar suporte a upload de áudio
- [x] Melhorar layout do painel com scroll responsivo
- [ ] Adicionar preview em tempo real do post
- [ ] Criar sistema de categorias/tags para posts
- [ ] Implementar agendamento de publicação
- [ ] Adicionar busca e filtros na listagem de posts
