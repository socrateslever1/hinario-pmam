              ...
              {(settings?.footer_instagram || settings?.footer_facebook) && (
                <div className="mt-2 flex items-center gap-3">
                  {settings?.footer_instagram && (
                    <a href={settings.footer_instagram} rel="noopener noreferrer" className="rounded-full p-1 text-white/65 transition-colors hover:text-[#c4a84b]" aria-label="Instagram">
                      <Instagram className="h-5 w-5" />
                    </a>
                  )}
                  {settings?.footer_facebook && (
                    <a href={settings.footer_facebook} rel="noopener noreferrer" className="rounded-full p-1 text-white/65 transition-colors hover:text-[#c4a84b]" aria-label="Facebook">
