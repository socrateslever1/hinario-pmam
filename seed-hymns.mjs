...
export const hymns = [
  ...
  {
    number: 27, title: "Canção TFM 1 - Cão de Guerra", subtitle: "Canção de TFM",
    author: null, composer: null, category: "tfm",
    description: "Cão de guerra preparar, para saltar, revesar e marchar. Canção vibrante de Treinamento Físico Militar.",
    lyrics: "Cão de guerra preparar\nPreparar para saltar\nSalto duplo de aeronave\nNo terreno vou pousar\n\nCão de guerra forjado\nNa marcha e no TFM\nSe a dor aparecer\nO guerreiro nem treme!"
  },
  {
    number: 28, title: "Canção TFM 2 - Polícia Militar", subtitle: "Canção de TFM",
    author: null, composer: null, category: "tfm",
    description: "Canção tradicional do TFM entoada nos batalhões da Polícia Militar do Amazonas.",
    lyrics: "Olha a dona Mag no terreno a cantar\nDisparando de rajada sem o fogo cessar\nPolícia Militar no asfalto e na mata\nGuerreiros de selva de boina e bravata!"
  },
  {
    number: 29, title: "Canção TFM 3 - Foi no Passo do Boiador", subtitle: "Canção de TFM",
    author: null, composer: null, category: "tfm",
    description: "Canção de fibra e ritmo de passada em grupo no TFM.",
    lyrics: "Foi no passo do boiador\nQue a tropa avançou\nCom suor e com garra\nO recruta vibrou!"
  },
  {
    number: 30, title: "Canção TFM 4 - Quando Eu Morrer", subtitle: "Canção de TFM",
    author: null, composer: null, category: "tfm",
    description: "Canção folclórica militar de corrida contínua.",
    lyrics: "Quando eu morrer quero ir de fardamento\nDe coturno e de gorro na hora do enterro\nNo meu caixão põe a minha cobertura\nQue no céu os anjos cantam a nossa bravura!"
  },
  {
    number: 31, title: "Canção TFM 5 - A Selva nos Espera", subtitle: "Canção de TFM",
    author: null, composer: null, category: "tfm",
    description: "Hino de marcha para tropas operantes na Amazônia.",
    lyrics: "A selva nos espera com sua imensidão\nOnde os fortes sobrevivem e os fracos caem no chão\nFormando os guerreiros de brio sem par\nA Polícia Militar nunca vai recuar!"
  },
  {
    number: 32, title: "Canção TFM 6 - Homens de Preto", subtitle: "Canção de TFM",
    author: null, composer: null, category: "tfm",
    description: "Homenagem aos grupos de operações especiais e patrulhamento tático.",
    lyrics: "Homens de preto qual é sua missão?\nEntrar na favela e deixar corpo no chão!\nHomens de preto o que é que você faz?\nEu faço coisas que assustam o satanás!"
  },
  {
    number: 33, title: "Canção TFM 7 - Sangue Vermelho", subtitle: "Canção de TFM",
    author: null, composer: null, category: "tfm",
    description: "Ritmo vigoroso para corridas de pelotas de alunos.",
    lyrics: "Sangue vermelho corre na veia\nA corrida é longa e a poeira incendeia\nMas o espírito de corpo não deixa ninguém cair\nJuntos começamos e juntos vamos concluir!"
  },
  {
    number: 34, title: "Canção TFM 8 - Fibra de Guerreiro", subtitle: "Canção de TFM",
    author: null, composer: null, category: "tfm",
    description: "Demonstração de força de vontade e condicionamento atlético militar.",
    lyrics: "A fibra do guerreiro se molda na fadiga\nQuanto mais o sol esquenta mais a tropa se instiga\nSem recuar, sem vacilar\nO ritmo do TFM é pra vitórias alcançar!"
  },
  {
    number: 35, title: "Canção TFM 9 - Tropa de Elite", subtitle: "Canção de TFM",
    author: null, composer: null, category: "tfm",
    description: "Canção motivacional para formação policial.",
    lyrics: "Tropa de elite os operacionais\nSempre preparados para os desafios reais\nNo calor da marcha, no peso do fuzil\nProtetores destemidos do nosso Brasil!"
  },
  {
    number: 36, title: "Canção TFM 10 - Olhai para Mim", subtitle: "Canção de TFM",
    author: null, composer: null, category: "tfm",
    description: "Canção de cadência de passada.",
    lyrics: "Olhai para mim e vejam quem eu sou\nUm soldado vibrante que a instrução forjou\nMarchando na cadência do bumbo e da voz\nNinguém segura o ritmo de todos nós!"
  },
  {
    number: 37, title: "Canção TFM 11 - Na Corrida de TFM", subtitle: "Canção de TFM",
    author: null, composer: null, category: "tfm",
    description: "Ritmo contínuo de TFM matinal.",
    lyrics: "Na corrida de TFM o recruta vai no pique\nNão sente cansaço nem aceita chilique\nPisa forte no asfalto faz a terra tremer\nTreinando todo dia para a patrulha vencer!"
  },
  {
    number: 38, title: "Canção TFM 12 - Minha Farda", subtitle: "Canção de TFM",
    author: null, composer: null, category: "tfm",
    description: "Orgulho de ostentar o fardamento policial militar.",
    lyrics: "Minha farda suada é meu galardão\nHonro este brasão do fundo do coração\nServindo ao Amazonas com fibra e valor\nNa paz ou na crise com muito ardor!"
  },
  {
    number: 39, title: "Canção TFM 13 - Sou Policial Militar", subtitle: "Canção de TFM",
    author: null, composer: null, category: "tfm",
    description: "Declaração de identidade militar.",
    lyrics: "Sou policial militar guerreiro de valor\nProtejo o cidadão seja onde for\nNas ruas de Manaus ou no interior\nCumprindo a missão com ética e amor!"
  },
  {
    number: 40, title: "Canção TFM 14 - Guerreiro Varonil", subtitle: "Canção de TFM",
    author: null, composer: null, category: "tfm",
    description: "Canção de vibração coletiva em formações.",
    lyrics: "Guerreiro varonil no brado da alvorada\nDesperta bem cedo pra encarar a jornada\nSupera os limites no treino e na raça\nEspírito de corpo que jamais se desfaza!"
  },
  {
    number: 41, title: "Canção TFM 15 - Marchando Sem Parar", subtitle: "Canção de TFM",
    author: null, composer: null, category: "tfm",
    description: "Canção de marcha militar para longos percursos.",
    lyrics: "Marchando sem parar sob o sol tropical\nA tropa avança firme com vigor sem igual\nUm passo, outro passo na mesma cadência\nA força da PMAM é pura resistência!"
  },
  {
    number: 42, title: "Canção TFM 16 - Selva Amazônica", subtitle: "Canção de TFM",
    author: null, composer: null, category: "tfm",
    description: "Canção de marcha no bioma amazônico.",
    lyrics: "Na selva amazônica o perigo é constante\nMas o nosso instinto nos mantém adiante\nPatrulha de selva com bússola e facão\nDefendendo as fronteiras da nossa nação!"
  },
  {
    number: 43, title: "Canção TFM 17 - Vibra Recruta", subtitle: "Canção de TFM",
    author: null, composer: null, category: "tfm",
    description: "Estimulo à vibração nos cursos de formação.",
    lyrics: "Vibra recruta não deixa a peteca cair\nA formatura está perto e a vitória vai vir\nCadência na corrida suor no chão\nFuturo policial do meu pelotão!"
  },
  {
    number: 44, title: "Canção TFM 18 - Garra e Coragem", subtitle: "Canção de TFM",
    author: null, composer: null, category: "tfm",
    description: "Canção de determinação atitude táctica.",
    lyrics: "Garra e coragem no peito a pulsar\nNenhuma barreira vai nos parar\nNa lama no asfalto no mar ou no ar\nA ordem e a paz nós vamos manter!"
  },
  {
    number: 45, title: "Canção TFM 19 - Sombra da Floresta", subtitle: "Canção de TFM",
    author: null, composer: null, category: "tfm",
    description: "Canção de infiltração e patrulhamento silencioso.",
    lyrics: "Na sombra da floresta o guerreiro caminha\nSilencioso e atento na retaguarda e na linha\nPronto pro combate pra agir e vencer\nÉ essa a nossa vida é esse o nosso dever!"
  },
  {
    number: 46, title: "Canção TFM 20 - Orgulho da Milícia", subtitle: "Canção de TFM",
    author: null, composer: null, category: "tfm",
    description: "Homenagem à história e tradição miliciana.",
    lyrics: "Orgulho da milícia de tempos passados\nHonrando o legado de bravos soldados\nCom garra no treino e firmeza no andar\nViva a Polícia Militar!"
  },
  {
    number: 47, title: "Canção TFM 21 - Patrulha Noturna", subtitle: "Canção de TFM",
    author: null, composer: null, category: "tfm",
    description: "Canção de patrulhamento e vigilância 24h.",
    lyrics: "Enquanto a cidade dorme em paz e sossego\nA patrulha noturna vigia sem medo\nProtegendo as famílias com bravura sem fim\nO Policial Militar responde assim!"
  },
  {
    number: 48, title: "Canção TFM 22 - Força da Amazônia", subtitle: "Canção de TFM",
    author: null, composer: null, category: "tfm",
    description: "Exaltação da força e resiliência militar nortista.",
    lyrics: "Força da Amazônia clima quente e severo\nForjando guerreiros com fibra de aço e de ferro\nNa marcha contínua a tropa ressoa\nA glória da PMAM por todo o estado ecoa!"
  },
  {
    number: 49, title: "Canção TFM 23 - Destemidos Guardiões", subtitle: "Canção de TFM",
    author: null, composer: null, category: "tfm",
    description: "Canto de camaradagem e cooperação no serviço.",
    lyrics: "Destemidos guardiões do povo amazonense\nNa rua ou na floresta a injustiça não vence\nUnidos no TFM fortes no patrulhamento\nServir e proteger a qualquer momento!"
  },
  {
    number: 50, title: "Canção TFM 24 - Chama da Vitória", subtitle: "Canção de TFM",
    author: null, composer: null, category: "tfm",
    description: "Canção de encerramento de treinos de TFM.",
    lyrics: "A chama da vitória nunca vai se apagar\nNo coração do guerreiro que aprendeu a lutar\nChegamos ao fim de mais uma jornada\nCom honra e dever na mente gravada!"
  }
];

async function seed() {
  console.log(`Seeding all ${hymns.length} hymns into pmam_hymns...`);
  ...
  console.log(`\nAll ${hymns.length} hymns seeded successfully!`);
  process.exit(0);
}
